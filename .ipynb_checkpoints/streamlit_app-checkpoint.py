...
with colguide1:
    st.markdown("#### 1️⃣ Remove Chart Borders")
    fig, ax = plt.subplots()
    ax.plot(x, y1, 'b-', label='Apple')
    ax.plot(x, y2, 'r-', label='Samsung')
    ax.scatter(x, y1, c='b', marker='o')
...
with colguide2:
    st.markdown("#### 2️⃣ Remove Grid Lines")
    fig, ax = plt.subplots()
    ax.plot(x, y1, 'b-', label='Apple')
    ax.plot(x, y2, 'r-', label='Samsung')
    ax.spines['top'].set_visible(False)
...
with colguide3:    
    st.markdown("#### 3️⃣ Remove Data Markers")
    fig, ax = plt.subplots()
    ax.plot(x, y1, 'b-', label='Apple')
    ax.plot(x, y2, 'r-', label='Samsung')
    ax.spines['top'].set_visible(False)
...
with colguide4:    
    st.markdown("#### 4️⃣ Clean Axis Labels")
    fig, ax = plt.subplots()
    ax.plot(x, y1, 'b-', label='Apple')
    ax.plot(x, y2, 'r-', label='Samsung')
    ax.spines['top'].set_visible(False)
...
df_styled = df.style.applymap(lambda x: 'color: red' if x == '|' else '', subset=pd.IndexSlice[[8], ['Column3']])
df_styled = df_styled.applymap(lambda x: 'font-weight: bold' if x == '|' else '', subset=pd.IndexSlice[[9], ['Column3']])
